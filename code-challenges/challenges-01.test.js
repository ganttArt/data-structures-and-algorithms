...
const addNumbers = (num, arr, times, callback) => {
  ...
  for (let i =0; i < times; i++) {
    arrCopy = callback(arrCopy, num);
  }
  return arrCopy;
};

// information on creating copies of arrays from https://www.samanthaming.com/tidbits/35-es6-way-to-clone-an-array/
